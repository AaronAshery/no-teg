...
lint:  ## run static analysis with flake8
	python3 -m black --check no_teg setup.py
	python3 -m flake8 no_teg setup.py

# Alias
lints: lint

format:  ## run autoformatting with black
	python3 -m black no_teg/ setup.py
...
annotate:  ## run type checking
	python3 -m mypy ./no_teg

#########
# TESTS #
#########
test: ## clean and run unit tests
	python3 -m pytest -v no_teg/tests

coverage:  ## clean and run unit tests with coverage
	python3 -m pytest -v no_teg/tests --cov=no_teg --cov-branch --cov-fail-under=75 --cov-report term-missing
