...
lint:  ## run static analysis with flake8
	python -m black --check no_teg setup.py
	python -m flake8 no_teg setup.py

# Alias
lints: lint

format:  ## run autoformatting with black
	python -m black no_teg/ setup.py
...
coverage:  ## clean and run unit tests with coverage
	python -m pytest -v no_teg/tests --cov=no_teg --cov-branch --cov-fail-under=75 --cov-report term-missing
